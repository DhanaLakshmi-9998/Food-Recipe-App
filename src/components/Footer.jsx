    ...
    return (
        <footer className="text-white py-20 bg_gradient ">
            <div className="container mx-auto px-20 lg:px-20 py-20 flex flex-col gap-10 md:flex-row justify-between border-t border-slate-800">
                ...
                <div className="flex flex-col">
                    ...
                    <div className="flex mt-4 gap-3">
                        <a
                            href='#'
                            className='bg-blue-600 p-1.5 rounded-sm text-white hover:text-black hover:scale-110'
                        >
                            <FaFacebook size={18} />
                        </a>
                        ...
                        <a
                            href='#'
                            className='bg-pink-600 p-1.5 rounded-sm text-white hover:text-black hover:scale-110'
                        >
                            <FaInstagram size={18} />
                        </a>
                        <a
                        ...
                        <a
                            href='#'
                            className='bg-red-600 p-1.5 rounded-sm text-white hover:text-black hover:scale-110'
                        >
                            <FaYoutube size={18} />
                        </a>
                    </div>
            ...
            <div className="flex items-center justify-center py-10">
                <span className="text-gray-400 leading-10">Food-recipe-app &copy; 2023</span>
            </div>
        </footer>
    )
}
