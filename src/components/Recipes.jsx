    ...
    return (
        <div className='w-full' style={{marginTop:"-100px"}}>
            <div className='w-full flex items-center justify-center pt-10 pb-5 px-0 md:px-10'>
                <form className='w-full lg:w-2/4' onSubmit={handleSearchedRecipe}>
                    <Searchbar placeholder="eg. Cake, Vegan, Chicken"
                        ...
                        rightIcon={
                            <BiSearchAlt2 className='text-gray-300 hover:text-green-200 hover:scale-110' onClick={handleSearchedRecipe} />
                        }
                    />
                </form>
...

            {
                recipes?.length > 0 ? (
                    <>
                        <div className='w-full  flex flex-wrap gap-5 px-5 lg:px-10 py-5'>
                            {
